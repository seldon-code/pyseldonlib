...
def test_io_agents():
  ...
  activities_expected  = [ 0.044554683389757696, 0.015813166022685163, 0.015863953902810535 ]
  ...
  for i in range(0, len(agents)):
     ...
     assert agents[i].data.activity == pytest.approx(activities_expected[i], abs =1e-16)
     assert agents[i].data.reluctance == pytest.approx(reluctances_expected[i], abs =1e-16)
