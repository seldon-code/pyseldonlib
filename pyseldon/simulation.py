...
def run_simulation_from_config_file(config_file_path, agent_file_path = None, network_file_path = None, output_file_path = None):
    ...
    """
    core.seldoncore.run_simulation(config_file_path = config_file_path, agent_file_path = agent_file_path, network_file_path = network_file_path, output_file_path = output_file_path)
...
def run_simulation_from_options(options, agent_file_path = None, network_file_path = None, output_file_path = None):
    ...
    output_file_path : str
        The path to the output file.
    """
    core.seldoncore.run_simulation(options = options, agent_file_path = agent_file_path, network_file_path = network_file_path, output_file_path = output_file_path)